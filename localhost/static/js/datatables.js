 ...
 *   https://datatables.net/download/#dt/dt-1.11.3/b-2.0.1/b-html5-2.0.1/date-1.1.1/sc-2.0.5
 *
 * Included libraries:
 *   DataTables 1.11.3, Buttons 2.0.1, HTML5 export 2.0.1, DateTime 1.1.1, Scroller 2.0.5
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.11.3/b-2.0.1/b-html5-2.0.1/date-1.1.1/sc-2.0.5",
